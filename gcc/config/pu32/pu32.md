   ...
   switch (which_alternative) {
     ...
     case 1:
       if (MEM_VOLATILE_P (operands[0]))
         return "rli %%sr, %0; st32 %1, %%sr # movsi_B_r #volatile";
       else
         return "rli %%sr, %0; st32 %1, %%sr # movsi_B_r";
     case 2:
       if (MEM_VOLATILE_P (operands[1]))
         return "rli %%sr, %1; ld32 %0, %%sr # movsi_r_B #volatile";
       else
         return "rli %%sr, %1; ld32 %0, %%sr # movsi_r_B";
     case 3:
       if (MEM_VOLATILE_P (operands[0]))
         return "st32 %1, %0 # movsi_W_r #volatile";
       else
         return "st32 %1, %0 # movsi_W_r";
     case 4:
       if (MEM_VOLATILE_P (operands[1]))
         return "ld32 %0, %1 # movsi_r_W #volatile";
       else
...
(define_insn "_movhi"
 ...
 ""
 {
   switch (which_alternative) {
     ...
     case 1:
       if (MEM_VOLATILE_P (operands[0]))
         return "rli %%sr, %0; st16 %1, %%sr # movhi_B_r #volatile";
       else
         return "rli %%sr, %0; st16 %1, %%sr # movhi_B_r";
     case 2:
       if (MEM_VOLATILE_P (operands[1]))
         return "rli %%sr, %1; ld16 %0, %%sr # movhi_r_B #volatile";
       else
         return "rli %%sr, %1; ld16 %0, %%sr # movhi_r_B";
     case 3:
       if (MEM_VOLATILE_P (operands[0]))
         return "st16 %1, %0 # movhi_W_r #volatile";
       else
         return "st16 %1, %0 # movhi_W_r";
     case 4:
       if (MEM_VOLATILE_P (operands[1]))
         return "ld16 %0, %1 # movhi_r_W #volatile";
       else
...
(define_insn "_movqi"
 ...
 ""
 {
   switch (which_alternative) {
     ...
     case 1:
       if (MEM_VOLATILE_P (operands[0]))
         return "rli %%sr, %0; st8 %1, %%sr # movqi_B_r #volatile";
       else
         return "rli %%sr, %0; st8 %1, %%sr # movqi_B_r";
     case 2:
       if (MEM_VOLATILE_P (operands[1]))
         return "rli %%sr, %1; ld8 %0, %%sr # movqi_r_B #volatile";
       else
         return "rli %%sr, %1; ld8 %0, %%sr # movqi_r_B";
     case 3:
       if (MEM_VOLATILE_P (operands[0]))
         return "st8 %1, %0 # movqi_W_r #volatile";
       else
         return "st8 %1, %0 # movqi_W_r";
     case 4:
       if (MEM_VOLATILE_P (operands[1]))
         return "ld8 %0, %1 # movqi_r_W #volatile";
       else
